Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                          ...
                          DESC
  s.homepage            = "https://github.com/PyHuT/RTMPCinaMaker"
  s.license             = 'MIT'
  s.authors             = { "Ihor Holia" => "pyhut1k@gmail.com" }
  s.source              = { :git => "https://github.com/PyHuT/RTMPCinaMaker", :tag => s.version.to_s }
